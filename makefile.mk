# makefile for client_ver1.c and kachimake.c kinzite.c
# copy this command: mingw32-make -f makefile.mk
client: client_ver1.o kachimake.o kinzite.o offense.o
	gcc -o client client_ver1.o kachimake.o kinzite.o offense.o -lws2_32
